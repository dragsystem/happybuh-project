...
public class Closer_Adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            b = false;
            if(infos.getName() == "final"){ 
            	v = li.inflate(com.happybuh.R.layout.closet_info_layout_final, null); 
            	b = true;
            }
            if(infos.getName() == "inicio"){ 
            	v = li.inflate(com.happybuh.R.layout.closet_info_layout_inicio, null);
            	final TextView tv = (TextView)v.findViewById(com.happybuh.R.id.closet_titulo);
            	tv.setTypeface(type);
            	b = true;
            }
        }
        if (!b) {
	        ...
	        if(name == "ChangeColor") {
	        	image1.setImageResource(R.drawable.buh_mini);
