...
public class ChangeGlasses extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iv2 = (ImageView)findViewById(R.id.glass_buy_bought);
    ...
    public void cambio_gafas1(View v) {
    	Long lg = Long.parseLong("" +5);
    	tv = (TextView)findViewById(R.id.glass_lvlreq_et);
        db.open();
	        level_req = Integer.parseInt(db.getGlassLvl(lg));
	    	precio_req = Integer.parseInt(db.getGlassPrice(lg));
	    	tv.setText(""+db.getGlassLvl(lg));
	    	tv = (TextView)findViewById(R.id.glass_price_et);
	    	tv.setText(""+db.getGlassPrice(lg));
	    	User_Info.num_glasses = db.getNumGlasses(lg);
	    	User_Info.col_glasses = db.getColGlasses(lg);
	    	comprado = db.getColorBought(lg);
	    db.close();
    	String imagen = User_Info.color_name + "_" + User_Info.num_glasses + "_" + User_Info.col_glasses + "_" + User_Info.num_beard + "_" + User_Info.col_beard;
    	iv.setImageResource(this.getResources().getIdentifier("drawable/" + imagen, null, this.getPackageName()));
    	if(comprado == 1)iv2.setImageResource(R.drawable.aplicar);
